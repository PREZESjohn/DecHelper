package com.project.dechelper.advisors;
...
// advisor to delete unneccesery <think> tags from LLM response (side effect of disabling thinking by using "/nothink" in prompt)
